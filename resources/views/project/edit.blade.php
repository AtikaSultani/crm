   ...
   <div class="row">
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form">
                    <form  method="POST"  action="{{url('/projects/'.$id) }}" class="form-horizontal" >
                        @csrf
                        @method('PUT')
                                        ...
                                        <div class="row reg-content-wrapper">
                                            ...
                                            <div class="col-sm-6 reg-right-content-wrapper">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control" name="NGO_name" value="{{$data->NGO_name}}"/>
                                                        @error('NGO_name')
                                                        <div style="color:red;">
                                                          {{$message}}
                                                        </div>
                                                  ...
                                                  <div class="form-group">
                                                      ...
                                                      <div class="col-md-6">
                                                          <input type="text" class="form-control" name="donors" value="{{$data->donors}}"/>
                                                          @error('donors')
                                                          <div style="color:red;">
                                                            {{$message}}
                                                          </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                      <textarea type="text"  class="form-control " name="activities" >{{$data->activities}}
                                                      </textarea>
                                                      @error('activities')
                                                      <div style="color:red;">
                                                        {{$message}}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text"  class="form-control " name="direct_beneficiaries" value="{{$data->direct_beneficiaries}}" />
                                            ...
                                            <div class="col-sm-6" style="direction: ltr">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-md-6">
                                                      <input type="text"  class="form-control " name="indirect_beneficiaries" value="{{$data->indirect_beneficiaries}}"/>
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-md-6">
                                                      <input type="text" class="form-control" name="on_budget" value="{{$data->on_budget_project}}"/>
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-md-6">
                                                      <input type="text" class="form-control" name="off_budget" value="{{$data->off_budget_project}}"/>
                                                  </div>
                                              </div>
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-md-6">
                                                      <input type="text" class="form-control" name="budget" value="$data->budget"/>
                                                  </div>
                                              </div>
                                              <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control" name="project_manager" value="{{$data->project_manager}}"/>
                                                    </div>
                                                </div>
