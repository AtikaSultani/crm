                ...
                <form method="post" id="search">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group" style="margin-bottom:0">
                            <a href="javascript:;"
                               onclick="do_filter_records('finance/students/filterStudent','stForm','student_table')"
                               class="btn btn-primary badge-pill" style="margin-top:25px;">
        ...
        <div class="col-lg-12">
            <header class="panel-heading">
                ...
                <div style="float:right;text-align:right;width:150px;margin-bottom:-10px;margin-top:-5px;background-color:#DAA520;color:#FFF5EE;">
                    <a href="{{ url('/projects/create') }}" style="color:#FFF5EE;text:bold;" class="btn green"
                       onclick="" title="create new project">
